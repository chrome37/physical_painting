...
class ActionBundle:
    ...
    def get_color(self):
        ...
        self.actions.go_to(5, self.positions.p01_left)
        self.actions.start_job()
        ...
        self.actions.go_to(2, self.positions.p01_right_up)
        self.actions.go_to(3, self.positions.p01_right)
        self.actions.start_job()
        ...
        self.actions.go_to(1, self.positions.p01)
        self.actions.go_to(2, self.positions.p01_left_up)
        self.actions.go_to(3, self.positions.p01_left)
        self.actions.start_job()
        self.__wait_moving(self.positions.p01_left)
        time.sleep(1)
