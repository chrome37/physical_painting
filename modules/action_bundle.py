...
class ActionBundle:
    ...
    def get_color(self):
        ...
        self.actions.go_to(4, self.positions.p01_left_up)
        self.actions.start_job()
        self.__wait_moving(self.positions.p01_left_up)
        time.sleep(1)
        ...
        self.actions.set_speed(self.config.get_color_speed, job_len)
        self.actions.set_smoothness(self.config.get_color_smoothness, job_len)
        self.actions.go_to(0, self.positions.p01_right_up)
        self.actions.start_job()
        self.__wait_moving(self.positions.p01_right_up)
        time.sleep(1)
        ...
        self.actions.set_speed(self.config.get_color_speed, job_len)
        self.actions.set_smoothness(self.config.get_color_smoothness, job_len)
        self.actions.go_to(0, self.positions.p01_left_up)
        self.actions.start_job()
        self.__wait_moving(self.positions.p01_left_up)
        time.sleep(1)
        ...
        self.actions.set_smoothness(self.config.get_color_smoothness, job_len)
        self.actions.go_to(0, self.positions.p01_right_up)
        self.actions.go_to(1, self.positions.p01_left_up)
        self.actions.go_to(2, self.positions.p01_left)
        self.actions.start_job()
        ...
        self.actions.set_smoothness(self.config.get_color_smoothness, job_len)
        self.actions.go_to(0, self.positions.p01_left_up)
        self.actions.go_to(1, self.positions.p01_right_up)
        self.actions.go_to(2, self.positions.p01_right)
        self.actions.start_job()
        self.__wait_moving(self.positions.p01_right)
        time.sleep(1)
        ...
        self.actions.refresh()
        job_len = self.actions.set_job_len(18)
        self.actions.set_speed(self.config.get_color_speed, job_len)
        self.actions.set_smoothness(self.config.get_color_smoothness, job_len)
        ...
        self.actions.go_to(7, self.positions.p04)
        self.actions.go_to(8, self.positions.p05)
        self.actions.go_to(9, self.positions.p02)
        self.actions.go_to(10, self.positions.p03)
        self.actions.go_to(11, self.positions.p04)
        self.actions.go_to(12, self.positions.p05)
        self.actions.go_to(13, self.positions.p02)
        self.actions.go_to(14, self.positions.p03)
        self.actions.go_to(15, self.positions.p00)
        self.actions.go_to(16, self.positions.i03)
        self.actions.go_to(17, self.positions.i01)
        self.actions.start_job()
        self.actions.wait_job(job_len)
